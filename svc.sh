...
SVC_NAME="actions.runner.cu-ecen-aeld-assignment-4-arunabh-hazarika-git.assignment-4.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (cu-ecen-aeld-assignment-4-arunabh-hazarika-git.assignment-4)"
